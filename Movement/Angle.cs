...
/// <summary>
/// Wrapper around float that stores angle in radians, provides type-safety and convenience.
/// When describing rotation in world, common convention is 0 for 'south'/'down'/(0, -1)
/// and increasing counterclockwise - so +90 is 'east'/'right'/(1, 0).
/// </summary>
public struct Angle
{
